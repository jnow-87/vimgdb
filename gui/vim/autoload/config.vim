...
let g:vimgdb_bin = get(g:, "vimgdb_bin", "vimgdb")
let g:vimgdb_gdb_cmd = get(g:, "vimgdb_gdb_cmd", "gdb -q")
let g:vimgdb_use_xterm = get(g:, "vimgdb_use_xterm", 0)

let g:vimgdb_userlog_show = get(g:, "vimgdb_userlog_show", 1)
let g:vimgdb_userlog_width = get(g:, "vimgdb_userlog_width", 40)
let g:vimgdb_userlog_height = get(g:, "vimgdb_userlog_height", 10)
let g:vimgdb_userlog_vertical = get(g:, "vimgdb_userlog_vertical", 0)

let g:vimgdb_gdblog_show = get(g:, "vimgdb_gdblog_show", 1)
let g:vimgdb_gdblog_width = get(g:, "vimgdb_gdblog_width", 40)
let g:vimgdb_gdblog_height = get(g:, "vimgdb_gdblog_height", 10)
let g:vimgdb_gdblog_vertical = get(g:, "vimgdb_gdblog_vertical", 0)

let g:vimgdb_break_show = get(g:, "vimgdb_break_show", 0)
let g:vimgdb_break_width = get(g:, "vimgdb_break_width", 40)
let g:vimgdb_break_height = get(g:, "vimgdb_break_height", 10)
let g:vimgdb_break_vertical = get(g:, "vimgdb_break_vertical", 1)

let g:vimgdb_inferior_show = get(g:, "vimgdb_inferior_show", 1)
let g:vimgdb_inferior_width = get(g:, "vimgdb_inferior_width", 40)
let g:vimgdb_inferior_height = get(g:, "vimgdb_inferior_height", 10)
let g:vimgdb_inferior_vertical = get(g:, "vimgdb_inferior_vertical", 1)

let g:vimgdb_variables_show = get(g:, "vimgdb_variables_show", 0)
let g:vimgdb_variables_width = get(g:, "vimgdb_variables_width", 40)
let g:vimgdb_variables_height = get(g:, "vimgdb_variables_height", 10)
let g:vimgdb_variables_vertical = get(g:, "vimgdb_variables_vertical", 1)

let g:vimgdb_callstack_show = get(g:, "vimgdb_callstack_show", 1)
let g:vimgdb_callstack_width = get(g:, "vimgdb_callstack_width", 40)
let g:vimgdb_callstack_height = get(g:, "vimgdb_callstack_height", 10)
let g:vimgdb_callstack_vertical = get(g:, "vimgdb_callstack_vertical", 0)

let g:vimgdb_register_show = get(g:, "vimgdb_register_show", 0)
let g:vimgdb_register_width = get(g:, "vimgdb_register_width", 40)
let g:vimgdb_register_height = get(g:, "vimgdb_register_height", 10)
let g:vimgdb_register_vertical = get(g:, "vimgdb_register_vertical", 1)

let g:vimgdb_memory_show = get(g:, "vimgdb_memory_show", 0)
let g:vimgdb_memory_width = get(g:, "vimgdb_memory_width", 40)
let g:vimgdb_memory_height = get(g:, "vimgdb_memory_height", 10)
let g:vimgdb_memory_vertical = get(g:, "vimgdb_memory_vertical", 0)

let g:vimgdb_per_show = get(g:, "vimgdb_per_show", 0)
let g:vimgdb_per_width = get(g:, "vimgdb_per_width", 40)
let g:vimgdb_per_height = get(g:, "vimgdb_per_height", 10)
let g:vimgdb_per_vertical = get(g:, "vimgdb_per_vertical", 1)
